...
class Cart extends Model {
	...
	public function setFreight($nrzipcode) {
		...
		if ($totals['nrqtd'] > 0) { //se tiver algum produto no carrinho, ele vai fazer algo
			...
			$this->setvlfreight(Cart::formatStateValueToDecimal($result->Valor));
	...
	public static function formatStateValueToDecimal($value):float {
